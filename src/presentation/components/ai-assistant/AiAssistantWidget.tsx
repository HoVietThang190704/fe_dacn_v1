  ...
  return (
    <>
      ...
      <button
        ...
        onClick={togglePanel}
        className={clsx(
          'fixed bottom-5 right-4 z-[60] flex items-center gap-3 rounded-full bg-gradient-to-r from-green-100 to-green-200 px-4 py-2 text-white shadow-xl ring-1 ring-green-200/40 transition hover:scale-105 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-amber-300 md:bottom-8 md:right-8',
