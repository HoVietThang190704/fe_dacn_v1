    ...
    <div className="group bg-white hover:bg-gray-50 transition-all duration-200 cursor-pointer border border-gray-200 hover:border-orange-300 rounded-xl overflow-hidden shadow-sm hover:shadow-lg transform hover:-translate-y-1">
      <div className="relative aspect-square overflow-hidden">
        ...
        <div className="absolute top-3 right-3 flex gap-1">
          <button
            onClick={handleEdit}
            className="bg-white/90 hover:bg-white text-gray-700 hover:text-orange-600 p-2 rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-200"
            title="Chỉnh sửa"
          >
          ...
          <button
            ...
            className="bg-white/90 hover:bg-red-50 text-gray-700 hover:text-red-600 p-2 rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-200"
            title="Xóa"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
