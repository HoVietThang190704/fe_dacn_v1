    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="max-w-sm rounded-2xl bg-white p-6 text-center shadow-lg">
        <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-red-100">
          <Image src={ICONS.WARNING} alt={translateSafely(t, 'dialog.warningAlt')} width={24} height={24} />
        </div>
        <h2 className="text-lg font-semibold text-gray-900">{translateSafely(t, 'errorTitle')}</h2>
