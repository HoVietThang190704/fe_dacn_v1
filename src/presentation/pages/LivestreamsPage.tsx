...
export const LivestreamsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-green-50">
      <div className="bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 text-white py-3 sm:py-6 relative overflow-hidden">
        <div className="container mx-auto px-2">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2 max-w-5xl mx-auto">
            <div className="text-center sm:text-left flex-1">
              ...
              <p className="mt-0 text-sm sm:text-base text-emerald-100 max-w-xl leading-relaxed">
                {t('subtitle')}
              </p>
            </div>

            <div className="flex-shrink-0 flex items-center gap-1 mt-0">
              <button onClick={() => router.push('/main/livestream/create')}
                aria-label={t('create')}
                className="inline-flex items-center gap-2 px-4 py-2 bg-white text-emerald-700 rounded-full font-semibold shadow hover:shadow-lg transition transform hover:-translate-y-0.5">
            ...
            <div className="flex justify-center mb-8 sm:mb-12">
              <div className="bg-white rounded-full p-1 sm:p-2 shadow-lg border border-gray-100 flex gap-1 sm:gap-2 w-full max-w-md sm:max-w-none">
                <button
                  ...
                  className={`px-4 sm:px-8 py-3 sm:py-4 rounded-full font-semibold text-sm sm:text-lg transition-all duration-300 flex items-center gap-2 sm:gap-3 flex-1 sm:flex-none ${activeTab === 'live'
                ...
                <button
                  ...
                  className={`px-4 sm:px-8 py-3 sm:py-4 rounded-full font-semibold text-sm sm:text-lg transition-all duration-300 flex items-center gap-2 sm:gap-3 flex-1 sm:flex-none ${activeTab === 'scheduled'
